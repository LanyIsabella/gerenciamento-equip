...
class Manutencao(Base):
    ...
    id_equipamento: Mapped[int] = mapped_column(ForeignKey("equipamentos.id"), nullable=False, index=True)
    id_responsavel: Mapped[int] = mapped_column(ForeignKey("usuarios.id"), nullable=False, index=True)
    ...
    responsavel: Mapped["Usuario"] = relationship(back_populates="manutencoes_responsaveis")
